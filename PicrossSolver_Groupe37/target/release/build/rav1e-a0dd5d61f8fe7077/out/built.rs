...
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.85.0 (4d91de4e4 2025-02-17) (built from a source tarball)";
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.85.0 (4d91de4e4 2025-02-17) (built from a source tarball)";
